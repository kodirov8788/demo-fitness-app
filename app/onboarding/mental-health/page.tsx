...
export default function OnboardingMentalHealthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Mental Health Assessment</CardTitle>
          <CardDescription className="text-center">Step 8 of 9</CardDescription>
        </CardHeader>
