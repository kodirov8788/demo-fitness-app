...
**Interaction**:
- Click to see meal suggestions
- Click to log meals (if feature included)
...
- Click to mark workout complete (if tracking)
...
**Data Source**:
- From active plan
- Integration with device (optional for MVP)

**Interaction**:
- Click to set sleep reminder
- Click to log sleep (if tracking)
...
**Interaction**:
- Click to start check-in
- Click to chat with Habi
...
2. Schedule recurring notifications (client-side or server-side)
