...
- **Expand Button**: Tap to see full details
...
1. **Card Style**:
   ...
   - Recommendation: Elevated for depth
...
**If user taps "Adjust with Habi"**:
1. **Conversation View** appears (modal or full screen)
...
**When user taps "Start with This Plan"**:
