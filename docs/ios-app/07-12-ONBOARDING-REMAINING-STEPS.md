...
### Step 7: Lifestyle & Values (`07-ONBOARDING-LIFESTYLE-VALUES.md`)
...
- Follow same View/ViewModel/Model structure
...
### Step 8: Motivation Assessment (`08-ONBOARDING-MOTIVATION.md`)
...
- Past failure experiences (Yes/No + text)
...
- Toggle + text area for past failures
...
### Step 9: Exercise Assessment (`09-ONBOARDING-EXERCISE.md`)
...
### Step 10: Dietary Assessment (`10-ONBOARDING-DIETARY.md`)
...
### Step 11: Mental Health Assessment (`11-ONBOARDING-MENTAL-HEALTH.md`)
...
### Step 12: Sleep Assessment (`12-ONBOARDING-SLEEP.md`)
...
2. **Create Data Model**
   ...
   - Make Codable for Firestore
   - Include validation

3. **Create ViewModel**

   - Follow BaseViewModel protocol
